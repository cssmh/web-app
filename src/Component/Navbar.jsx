...
const Navbar = () => {
  ...
  return (
    <div className="border-b border-gray-700 py-[7px]">
      <header className="container 2xl:max-w-[1370px] mx-auto sticky top-0 left-0 right-0 z-50 bg-[#111111] text-gray-200 shadow-md px-4 md:px-6">
        <div className="flex justify-between items-center h-11 2xl:h-14">
